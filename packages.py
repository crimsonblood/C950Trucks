...
for index, value in enumerate(packageImport.get_second_delivery()):
    packageImport.get_second_delivery()[index][9] = second_leave_times[0]
    second_delivery.append(packageImport.get_second_delivery()[index])
...
for index, value in enumerate(packageImport.get_final_delivery()):
    packageImport.get_final_delivery()[index][9] = third_leave_times[0]
    third_delivery.append(packageImport.get_final_delivery()[index])
